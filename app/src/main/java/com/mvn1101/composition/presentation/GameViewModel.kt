...
import com.mvn1101.composition.data.GameRepositoryImpl
...
import com.mvn1101.composition.domain.usecases.GenerateQuestionUseCase
import com.mvn1101.composition.domain.usecases.GetGameSettingsUseCase
...
class GameViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private fun checkAnswer (number: Int){
        var rightAnswer = question.value?.rightAnswer
